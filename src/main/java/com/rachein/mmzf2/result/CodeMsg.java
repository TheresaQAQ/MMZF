...
public class CodeMsg {
    ...
    //用户：5003xx
    public static CodeMsg USER_NOT_FOUND = new CodeMsg(500301, "找不到用户信息！");
    ...
    public static CodeMsg USER_NOT_ADMIT_YET = new CodeMsg(500304, "尚未通过认证！");
    ...
    public static CodeMsg DRAFT_EMPTY = new CodeMsg(500403, "当前文章为空哦");
    public static CodeMsg DRAFT_SAVE_TO_VX_ERROR = new CodeMsg(500404, "保存到微信推文失败！");
    ...
    //图文：5006xx
    public static CodeMsg MEDIA_DDL = new CodeMsg(500601, "图文已过期！");
