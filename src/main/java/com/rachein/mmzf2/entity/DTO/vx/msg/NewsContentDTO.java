...
public class NewsContentDTO {
    ...
    public NewsContentDTO(NewsContentDetailsDTO first, NewsContentDetailsDTO keyword1, NewsContentDetailsDTO keyword2, NewsContentDetailsDTO keyword3, NewsContentDetailsDTO keyword4) {
        this.first = first;
        this.keyword1 = keyword1;
        this.keyword2 = keyword2;
        this.keyword3 = keyword3;
